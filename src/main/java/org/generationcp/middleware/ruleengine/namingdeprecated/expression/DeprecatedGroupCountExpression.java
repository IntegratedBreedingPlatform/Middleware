...
@Deprecated
@Component
public class DeprecatedGroupCountExpression extends DeprecatedBaseExpression {
	...
	protected String getCountPrefix(final String input) {
		final int start = input.indexOf(DeprecatedGroupCountExpression.KEY);
	...
	protected String getTargetCountExpression(final String countPrefix) {
		if (DeprecatedGroupCountExpression.BULK_COUNT_PREFIX.equals(countPrefix)) {
			return "B";
		} else if (DeprecatedGroupCountExpression.POUND_COUNT_PREFIX.equals(countPrefix)) {
			return "#";
		} else {
	...
	public String getExpressionKey() {
		return DeprecatedGroupCountExpression.KEY;
	}
