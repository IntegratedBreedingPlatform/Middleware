...
public class GermplasmDto {
	...
	private List<RecordAttributeDto> attributes;
	...
	public List<RecordAttributeDto> getAttributes() {
		return this.attributes;
	}

	public void setAttributes(final List<RecordAttributeDto> attributes) {
