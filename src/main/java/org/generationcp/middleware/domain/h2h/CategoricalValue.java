...
/**
 * Used to contain the categorical values found in phenotype table together with the frequency of occurrence of the value.
 *
 */
public class CategoricalValue {
	...
	public void print(int indent) {
		Debug.println(indent, "Value Id: " + this.getId());
		Debug.println(indent, "Value Name: " + this.getName());
		Debug.println(indent, "Value Count: " + this.getCount());
