...
public enum TraitType {
	...
	NUMERIC(Arrays.asList(TermId.NUMERIC_VARIABLE.getId(), TermId.DATE_VARIABLE.getId())), CHARACTER(Arrays
			.asList(TermId.CHARACTER_VARIABLE.getId())), CATEGORICAL(Arrays.asList(TermId.CATEGORICAL_VARIABLE.getId()));
