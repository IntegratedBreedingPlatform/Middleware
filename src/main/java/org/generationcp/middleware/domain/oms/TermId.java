...
public enum TermId {
	...
	, RANDOMIZED_COMPLETE_BLOCK(10110), RESOLVABLE_INCOMPLETE_BLOCK(10130), RESOLVABLE_INCOMPLETE_ROW_COL(10145), RESOLVABLE_INCOMPLETE_BLOCK_LATIN(
			10166), RESOLVABLE_INCOMPLETE_ROW_COL_LATIN(10167), OTHER_DESIGN(10168), ALPHA_LATTICE_E30_REP2(10121), ALPHA_LATTICE_E30_REP3(
			10122), ALPHA_LATTICE_E50_REP2(10123), EXPT_DESIGN_SOURCE(8165)
