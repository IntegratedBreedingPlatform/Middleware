...
public enum TermId {
	...
	// Study Fields
	, STUDY_NAME(8005), PM_KEY(8040), STUDY_TITLE(8007), STUDY_OBJECTIVE(8030), PI_ID(8110), PI_NAME(8100)
	//START_DATE(8050), END_DATE(8060)
	, STUDY_UID(8020), STUDY_INSTITUTE(8080)
	/* , STUDY_IP(8120) */
	...
	// Stock Plot / Fieldmap
	, PLOT_NO(8200), PLOT_NNO(8380), PLOT_CODE(8350), REP_NO(8210), BLOCK_NO(8220), COLUMN_NO(8400), PLOT_ID(8201) //
	// (32769)
	, RANGE_NO(8410)
	// (32770)
	...
	, COMMENT_INVENTORY(1714), LOT_ID_INVENTORY(1715), LOT_LOCATION_INVENTORY(1720), NEW_RESERVED_INVENTORY(1716), RESERVED_INVENTORY(1717), TOTAL_INVENTORY(
			1718), UNITS_INVENTORY(1719), SCALE_INVENTORY(1721), AMOUNT_INVENTORY(1722) , RESERVATION(1738), LOT_STATUS(1739)
