...
public enum TermId {
	...
	, HAS_METHOD(1210), HAS_PROPERTY(1200), HAS_SCALE(1220), HAS_TYPE(1105), HAS_VALUE(1190), IS_A(1225), STORED_IN(1044)
	...
	/* , STUDY_IP(8120) */
	, CREATION_DATE(8048), STUDY_STATUS(8006), STUDY_UPDATE(8009)
	...
	// Other
	, ORDER(1420), MIN_VALUE(1113), MAX_VALUE(1115), CROP_ONTOLOGY_ID(1226)
