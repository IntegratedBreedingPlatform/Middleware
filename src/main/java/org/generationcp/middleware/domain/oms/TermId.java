...
public enum TermId {
	...
	// Location
	, TRIAL_LOCATION(8180), LOCATION_ID(8190), SITE_NAME(8196), COOPERATOOR_ID(8372), COOPERATOR(8373)
	...
	, RANDOMIZED_COMPLETE_BLOCK(10110), RESOLVABLE_INCOMPLETE_BLOCK(10130), RESOLVABLE_INCOMPLETE_ROW_COL(10145), RESOLVABLE_INCOMPLETE_BLOCK_LATIN(
			10166), RESOLVABLE_INCOMPLETE_ROW_COL_LATIN(10167), OTHER_DESIGN(10168), ALPHA_LATTICE_E30_REP2(10169), ALPHA_LATTICE_E30_REP3(
			10170), ALPHA_LATTICE_E50_REP2(10171)
