...
public enum TermId {
	...
	, STUDY_EXPERIMENT(1010), DATASET_EXPERIMENT(1050), TRIAL_ENVIRONMENT_EXPERIMENT(1020), PLOT_EXPERIMENT(1155), SAMPLE_EXPERIMENT(1160), AVERAGE_EXPERIMENT(
			1170), SUMMARY_EXPERIMENT(1180), SUMMARY_STATISTICS_EXPERIMENT(1181)
	...
	// Stock Type
	, ENTRY_CODE(8300), ENTRY_NO(8230), SOURCE(8360), CROSS(8377), DESIG(8250)
	...
	// germplasm list
	IMMEDIATE_SOURCE_GID(-6), IMMEDIATE_SOURCE_NAME(-7), GROUP_SOURCE_GID(-8), GROUP_SOURCE_NAME(-9), GUID(-10), GERMPLASM_REFERENCE(-11)
