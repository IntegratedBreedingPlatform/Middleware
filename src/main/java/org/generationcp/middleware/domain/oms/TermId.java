...
public enum TermId {
	...
	// Stock Type
	, ENTRY_CODE(8300), ENTRY_NO(8230), IMMEDIATE_SOURCE_NAME(8378), CROSS(8377), DESIG(8250)
	...
	// germplasm list
	IMMEDIATE_SOURCE_GID(-6), GROUP_SOURCE_GID(-8), GROUP_SOURCE_NAME(-9), GUID(-10), GERMPLASM_REFERENCE(-11)
