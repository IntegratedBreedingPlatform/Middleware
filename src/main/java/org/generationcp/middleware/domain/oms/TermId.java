...
public enum TermId {
    ...
    , BREEDING_METHOD_NAME (1701)
    , BREEDING_METHOD_ABBREVIATION (1702)
    , BREEDING_METHOD_NUMBER (1703)
    , BREEDING_METHOD_GROUP (1704)
    , CROSS_FEMALE_GID (1705)
    , CROSS_FEMALE_PREFERRED_NAME (1706)
    , CROSS_MALE_GID (1707)
    , CROSS_MALE_PREFERRED_NAME (1708)
    , GERMPLASM_DATE (1709)
    , GERMPLASM_LOCATION (2110)
    , PREFERRED_ID (1711)
    , PREFERRED_NAME (1712)
    , SEED_RESERVATION (1713)
    , FEMALE_PARENT (1723)
    , MALE_PARENT (1724)
    , FGID (1725)
    , MGID (1726)
    ...
    , COMMENT_INVENTORY (1714)
    , LOT_ID_INVENTORY (1715)
    , LOT_LOCATION_INVENTORY (1720)
    , NEW_RESERVED_INVENTORY (1716)
    , RESERVED_INVENTORY (1717)
    , TOTAL_INVENTORY (1718)
    , UNITS_INVENTORY (1719)
    , SCALE_INVENTORY (1721)
