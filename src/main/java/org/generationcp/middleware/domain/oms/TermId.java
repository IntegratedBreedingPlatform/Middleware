...
public enum TermId {
	...
	// Stock Type
	, ENTRY_CODE(8300), ENTRY_NO(8230), SOURCE(8360), CROSS(8377), DESIG(8250), CHECK(8255)
	...
	, NONEXISTENT(-1), SAMPLES(-2), GID_ACTIVE_LOTS_COUNT(-3), GID_AVAILABLE_BALANCE(-4), GID_UNIT(-5), STOCKID(-8269)
