...
public class StudyDataManagerImpl extends DataManager implements StudyDataManager {
	...
	@Override
	public long countExperimentsByVariable(final int variableId, final int variableTypeId) throws MiddlewareQueryException {
					...
					if (valueKey.equals(String.valueOf(TermId.START_DATE.getId()))) {
						...
						props.put(key, prop.getValue());
							...
							if (valueKey.equals(String.valueOf(TermId.LOCATION_ID.getId()))) {
								studySummary.setLocationId(
										prop.getValue() != null && !prop.getValue().equals("") ? Integer.valueOf(prop.getValue()) : null);
							} else {
