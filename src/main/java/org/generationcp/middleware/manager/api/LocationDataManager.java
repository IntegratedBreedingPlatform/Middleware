...
public interface LocationDataManager {
    ...
    /**
     * Returns all the Location records with country and location type  matching  the given parameter. 
     * The data is retrieved from both local and central databases.
     *
     * @param country - search string for the country of the locations
    ...
    /**
     * Returns all the Location records with name, country and location type  matching  the given parameter. 
     * The data is retrieved from both local and central databases.
     *
     * @param name the name
    ...
    /**
     * Returns the number of Locations with countries matching the given parameter. 
     * The data is retrieved from both local and central databases.
     *
     * @param country - search string for the country of the locations
     * @return Number of Locations
     ...
     * 
     * Return a List of Locations which represent 
     * the breeding locations stored in the location table of IBDB.
     *
     ...
     * 
     * Return the total count of Locations which represent 
     * the breeding locations stored in the location table of IBDB.
     *
     * @return the long
     * @throws MiddlewareQueryException the middleware query exception
     ...
     * @throws MiddlewareQueryException the middleware query exception
     */
    List<LocationDetails> getLocationDetailsByLocationIDs(List<Integer> ids) 
            throws  MiddlewareQueryException;
