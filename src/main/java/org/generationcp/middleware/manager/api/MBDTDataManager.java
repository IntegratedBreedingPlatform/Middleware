...
public interface MBDTDataManager {
     ...
     * @return A list of SelectedGenotype objects representing entries in the mbdt_selected_genotypes table associated with the provided generation ID and whose type is marked as selected
     * @throws MiddlewareQueryException if the provided generation ID refers to a non existent entry in the mbdt_generations table
     */
     ...
     * @return A list of SelectedGenotype objects representing entries in the mbdt_selected_genotypes table associated with the given generation ID
     * @throws MiddlewareQueryException if the provided generation ID refers to a non existent entry in the mbdt_generations table
     */
     ...
     * @param gids A list of GIDs. Existing GID entries will have their selected status toggled on / off. Non existing GID entries will be saved to the mbdt_selected_genotypes table with sg_type = 'SR'
     * @throws MiddlewareQueryException if the provided generation ID refers to a non existent entry in the mbdt_generations table
     */
     ...
     * @param genotypeEnum The parent data type to which the entry will be saved / modified. Possible values are SelectedGenotypeEnum.R or SelectedGenotypeEnum.D only.
     * @param gids A list of GIDs. Existing GID entries will have their parent data type modified (while still retaining the selected prefix if existing).
     *             Non existing GID entries will be saved to the mbdt_selected_genotypes table with sg_type equal to the provided value for genotypeEnum
     * @throws MiddlewareQueryException if the provided generation ID refers to a non existent entry in the mbdt_generations table
     */
