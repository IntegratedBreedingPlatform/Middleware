...
public interface GermplasmListManager
{
	...
	/**
	 * Returns the germplasm list entries that belong to the list identified by the given id
	 * and have gids equal to the given parameter.
	 * 
	 * @param listId
	 * @param gid
	 * @return List of GermplasmListData POJOs
	 ...
	 * @param germplasmList - The {@code GermplasmList} object to be persisted to the database.
	 * Must be a valid {@code GermplasmList} object.
	 * @return Returns the number of {@code GermplasmList} records inserted in the database.
	 * @throws QueryException
	 */
	 ...
	 * @param germplasmLists - A list of {@code GermplasmList} objects to be persisted to the database.
	 * {@code GermplasmList} objects must be valid.
	 * @return Returns the number of {@code GermplasmList} records inserted in the database.
	 * @throws QueryException
	 */
	 ...
	 * @param germplasmList - The {@code GermplasmList} object to be updated in the database.
	 * Must be a valid {@code GermplasmList} object.
	 * @return Returns the number of {@code GermplasmList} records updated in the database.
	 * @throws QueryException 
	 */
	 ...
	 * 
	 * @param germplasmLists - A list of {@code GermplasmList} objects to be updated in the database.
	 * {@code GermplasmList} objects must be valid.
	 * @return Returns the number of {@code GermplasmList} records updated in the database.
	 * @throws QueryException 
	 */
	 ...
	 * @param germplasmList - The {@code GermplasmList} object to be removed from the database. 
	 * Must be a valid {@code GermplasmList} object.
	 ...
	 * @param germplasmLists - A list of {@code GermplasmList} objects to be removed from the database.
	 * {@code GermplasmList} objects must be valid.
	 * @return Returns the number of {@code GermplasmList} objects deleted from the database.
	 * @throws QueryException 
	 */
	...
	/**
	 * Removes the corresponding {@code GermplasmList} record and all related Data from the database given
	 * the List ID.
	 ...
	 * @param germplasmListData - The {@code GermplasmListData} object to be persisted to the database.
	 * Must be a valid {@code GermplasmListData} object.
	 * @return Returns the number of {@code GermplasmListData} records inserted in the database.
	 * @throws QueryException
	 */
	 ...
	 * @param germplasmListDatas - A list of {@code GermplasmListData} objects to be persisted to the database.
	 * {@code GermplasmListData} objects must be valid.
	 * @return Returns the number of {@code GermplasmListData} records inserted in the database.
	 * @throws QueryException
	 */
	 ...
	 * @param germplasmListData - The {@code GermplasmListData} object to be updated in the database.
	 * Must be a valid {@code GermplasmListData} object.
	 ...
	 * @param germplasmListDatas - A list of {@code GermplasmListData} objects to be updated in the database.
	 * Must be valid {@code GermplasmListData} objects.
	 * @return Returns the number of {@code GermplasmListData} records updated in the database. 
	 * @throws QueryException 
	 */
	...
	/**
	 * Removes the corresponding {@code GermplasmListData} record from the database given its
	 * List ID and Entry ID.
	...
	/**
	 * Removes the corresponding {@code GermplasmListData} records from the database given
	 * their List ID.
	 ...
	 * @param germplasmListData - The {@code GermplasmListData} object to be removed from the database. 
	 * Must be a valid {@code GermplasmListData} object.
	 ...
	 * @param germplasmListDatas - A list of {@code GermplasmListData} objects to be removed from the database.
	 * {@code GermplasmListData} objects must be valid.
	 * @return Returns the number of {@code GermplasmListData} records deleted from the database.
	 * @throws QueryException 
	 */
