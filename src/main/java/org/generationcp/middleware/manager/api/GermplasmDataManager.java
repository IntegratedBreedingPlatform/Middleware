...
{
	/**
	 * Searches for all germplasm records which matches the given name.  Three searching modes are available;
	 * normal search, the spaces on the name will be removed, the name will be standardize before searching.
	 * The three modes can be specified using the enum FindGermplasmByNameModes.
	 * 
	 * Names to be included in the search may be limited by name status.  Accepted values are 0 - 10.  If the given status is
	 * zero all names will be included in the search.
	 * 
	 * Names to be included in the search may be limited by name type.  The enum GermplasmNameType is used to specify the type
	 * of names to be included in the search.  If the given type is null, all names will be included
	 * in the search.
	 * 
	 ...
	 * can also be specified like in using the findGermplasmByName() method.
	 * 
	 * Names to be included in the search may be limited by name status.  Accepted values are 0 - 10.  If the given status is
	 * zero all names will be included in the search.
	 * 
	...
	/**
	 * Given a gid, return the Germplasm POJO representing the record identified by the id
	 * with its preferred name.
	 * 
	...
	/**
	 * Given a gid, return the Germplasm POJO representing the record identified by the id
	 * with its preferred name and preferred abbreviation.
	 * 
	 * @param gid - the id of the germplasm record to be retrieved
	 * @return the Germplasm POJO representing the record
	 */
	 ...
	 * 
	 * Results may be filtered by name status.  Accepted values are 0 - 10.  If the given status is
	 * zero all names will be included in the result.
	 * 
	 * Results may also be filtered by type.  The enum GermplasmNameType is used to specify the type
	 * of names to be included in the result.  If the given type is null, all names will be included
	 * in the result.
	 * 
	 ...
	 * 
	 * @param gid - id of the Germplasm
	 * @return {@code Name} POJO of the Germplasm's preferred name.
	 * Returns {@code null} when no preferred name is found.
	 * @throws QueryException
	 */
	 ...
	 * @return {@code Name} POJO of the matching {@code Name} object.
	 * Returns {@code null} when no {@code Name} with the specified gid and nval is found.
	 * @throws QueryException
	 */
	 ...
	 * @param location - The {@code Name} object to be persisted to the database.
	 * Must be a valid {@code Name} object.
	 * @return Returns the number of Germplasm Name records inserted in the database.
	 * @throws QueryException
	 */
	 ...
	 * @param names - A list of {@code Name} objects to be persisted to the database.
	 * {@code Name} objects must be valid.
	 * @return Returns the number of {@code Name} records inserted in the database.
	 * @throws QueryException
	 */
	 ...
	 * @param location - The {@code Name} object to be updated in the database.
	 * Must be a valid {@code Name} object.
	 * @return Returns the number of Germplasm Name records updated in the database.
	 ...
	 * 
	 * @param names - A list of {@code Name} objects to be updated in the database.
	 * {@code Name} objects must be valid.
	 * @return Returns the number of {@code Name} records updated in the database.
	 * @throws QueryException 
	 */
	 ...
	 * @return Returns the number of {@code Location} records inserted in the database.
	 * @throws QueryException
	 */
	 ...
	 * @param location - The {@code Bibref} object to be persisted to the database.
	 * Must be a valid {@code Bibref} object.
	 * @return Returns the number of {@code Bibref} records inserted in the database.
	 * @throws QueryException
	 */
	...
	/**
	 * Returns the Germplasm representing the children of the Germplasm identified
	 * by the given gid.  The function returns a List of Object arrays.  Each Object array
	 * contains 2 elements, the first is an int to specify the progenitor number and the
	 * second is the Germplasm POJO representing the child germplasm.
	 * 
	...
	/**
	 * Returns the number of children of the Germplasm identified by the
	 * given gid.
	 * 
	 * @param gid
	...
	/**
	 * Returns the Germplasm which are management group neighbors of the Germplasm identified
	 * by the given GID.  The given Germplasm is assumed to be a root of a management group.
	 * The Germplasm POJOs included in the results come with their preferred names which
	 * can be accessed by calling Germplasm.getPreferredName(). 
	 * 
	 * @param gid
	 * @return List of Germplasm POJOs
	 * @throws QueryException
	...
	/**
	 * Returns the Germplasm which are group relatives of the Germplasm identified
	 * by the given GID.  The Germplasm POJOs included in the results come with their preferred names which
	 * can be accessed by calling Germplasm.getPreferredName().
	 * 
	 * @param gid
	 * @return List of Germplasm POJOs
	...
	/**
	 * Returns the generation history of the Germplasm identified by the given GID.  The history is created
	 * by tracing back through the source germplasms from the given Germplasm through its progenitors, up
	 * until a Germplasm created by a generative method is encountered.
	 * The Germplasm POJOs included in the results come with their preferred names which
	 * can be accessed by calling Germplasm.getPreferredName(). 
	 *  
	 * @param gid
	 * @return List of Germplasm POJOs, arranged from the given Germplasm down to the last source on 
	...
	/**
	 * Returns the GermplasmPedigreeTree object which represents the derivative neighborhood for the germplasm
	 * identified by the given gid.  The derivative neighborhood is created by tracing back the source parents
	 * from the given germplasm until the given number of steps backward is reached or the first source germplasm
	 * created by a generative method is reached, whichever comes first.  The last source parent reached by tracing
	 * back becomes the root of the GermplasmPedigreeTree object.  From the root, all immediate derived lines are
	 * retrieved and added to the tree.  And then from each of those derived germplasms, all immediate derived
	 * lines are retrieved and added to the tree, and so on and so forth.  The number of levels of the tree
	 * is the sum of the actual number of steps backward made to reach the root and the given number of steps forward
	 * plus 1 (for the level which the given germplasm belongs). 
	 * 
	 ...
	 */
	public GermplasmPedigreeTree getDerivativeNeighborhood(Integer gid, int numberOfStepsBackward, int numberOfStepsForward) throws QueryException;
	
	/**
	 * Returns the Germplasm records with field values matching the specified values on the given
	 * sample Germplasm object.  The following fields will be checked for matches: method, gnpgs, 
	 * gpid1, gpid2, user, location, gdate, reference, mgid, and attributes.
	 * 
	 * @param sample
	 * @param start
	 * @param numOfRows
	 * @return List of Germplasm POJOs
	 */
	//public List<Germplasm> findGermplasmByExample(Germplasm sample, int start, int numOfRows);
	
	/**
	 * Returns the number of Germplasm records with field values matching the specified values on the given
	 * sample Germplasm object.  The following fields will be checked for matches: method, gnpgs, 
	 * gpid1, gpid2, user, location, gdate, reference, mgid, and attributes.
	 * 
	 * @param sample
	...
	/**
	 * Given the gid of the child germplasm, the gid of the parent germplasm and the progenitor number,
	 * this method makes the necessary changes to save the relationship on the database.
	 * 
	 * This method will either update the Germplasm record, to change the gpid1 or gpid2 fields
	 * (if the progenitor number given is 1 or 2), or will either add or update the 
	 * Progenitor record which represents this relationship.  A new Progenitor record will be
	...
	/**
	 * Given a valid Germplasm object with a matching valid Name object to be set as its preferred name,
	 * add a new Germplasm record and a new Name record for the given parameters.
	 * 
	 * @param germplasm
	 * @param preferredName
	 ...
	 * 
	 * Note that you need to assign temporary ids for the Germplasm objects so that they can serve
	 * as the keys for the Map.  The function will replace these temp ids with the correct ones
