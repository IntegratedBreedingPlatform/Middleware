...
/**
 * This is the API for retrieving information about Traits, Scales, and Trait Methods.
 *  
...
public interface TraitDataManager
{
	...
	/**
	 * Returns the description of a given discrete value of a scale identified by the given id.
	 * 
	 * @param scaleId
	 * @param value
	 * @return
	...
	/**
	 * Returns discrete values, represented as ScaleDiscrete objects, of the Scale identified by
	 * the given id.
	 *  
	 * @param scaleId
	...
	/**
	 * Returns the ScaleContinuous object which contains the start and end of the range of values
	 * for the Scale identified by the given id.
	 * 
	 * @param scaleId
	 * @return
	 */
	...
	/**
	 * Returns all Scale records associated with the Trait identified by the given id.
	 * 
	 * @param traitId
	 * @return
	 */
	...
	/**
	 * Return all Trait Method records associated with the Trait identified by the given id.
	 * 
	 * @param traitId
	 * @return List of TraitMethod POJOs
	 */
