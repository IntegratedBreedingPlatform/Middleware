...
public class InventoryDataManagerImpl extends DataManager implements InventoryDataManager{
    ...
    @Override
    public int addTransaction(org.generationcp.middleware.pojos.Transaction transaction) throws QueryException {
    ...
    @Override
    public int addTransaction(List<org.generationcp.middleware.pojos.Transaction> transactions) throws QueryException {
        return addOrUpdateTransaction(transactions, Operation.ADD);
    }

    @Override
    public int updateTransaction(org.generationcp.middleware.pojos.Transaction transaction) throws QueryException {
        List<org.generationcp.middleware.pojos.Transaction> transactions = new ArrayList<org.generationcp.middleware.pojos.Transaction>();
        transactions.add(transaction);
    ...
    @Override
    public int updateTransaction(List<org.generationcp.middleware.pojos.Transaction> transactions) throws QueryException {
        return addOrUpdateTransaction(transactions, Operation.UPDATE);
    }
