...
public abstract class DataManager<T> {
     ...
     *            the hibernate util for central
     */
    public DataManager(HibernateUtil hibernateUtilForLocal,
     ...
     *             the query exception
     */
    protected HibernateUtil getHibernateUtil(Database instance)
	    throws QueryException {
	if ((instance == Database.CENTRAL)) {
		...
		throw new QueryException(
			"The central instance was specified "
		...
		throw new QueryException(
			"The local instance was specified "
