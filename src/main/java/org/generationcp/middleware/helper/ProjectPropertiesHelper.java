...
public class ProjectPropertiesHelper {
	...
	private final ProjectValues projectValues;

	public ProjectPropertiesHelper(List<ProjectProperty> properties) {
		this.projectValues = new ProjectValues(properties);
	}

	public String getString(TermId standardVariableId) {
		return this.projectValues.getValue(standardVariableId.getId());
	}

	public Integer getInteger(TermId standardVariableId) {
		return this.projectValues.getIntValue(standardVariableId.getId());
	}
}
