...
public class StudyTransactionsDto extends TransactionDto {
	...
	public StudyTransactionsDto(final Integer transactionId, final String createdByUsername, final String transactionType,
		final Double amount, final String notes, final Date createdDate, final Integer lotId, final String lotUUID,
		...
		super(transactionId, createdByUsername, transactionType, amount, notes, createdDate, lotId, lotUUID, gid, designation, stockId,
