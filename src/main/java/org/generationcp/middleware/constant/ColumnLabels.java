...
public enum ColumnLabels {
	...
	IMMEDIATE_SOURCE_GID(TermId.CROSS_MALE_GID, "IMMEDIATE SOURCE GID"),
	IMMEDIATE_SOURCE_PREFERRED_NAME(TermId.CROSS_MALE_PREFERRED_NAME, "IMMEDIATE SOURCE"),
	GROUP_SOURCE_GID(TermId.CROSS_FEMALE_GID, "GROUP SOURCE GID"),
	GROUP_SOURCE_PREFERRED_NAME(TermId.CROSS_FEMALE_PREFERRED_NAME, "GROUP SOURCE"),
	...
	static {
		...
		ColumnLabels.ADDABLE_GERMPLASM_COLUMNS.add(ColumnLabels.IMMEDIATE_SOURCE_PREFERRED_NAME.getName());
