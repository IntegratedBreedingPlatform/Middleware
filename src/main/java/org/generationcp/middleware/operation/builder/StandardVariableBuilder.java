...
public class StandardVariableBuilder extends Builder {
	...
	public List<StandardVariableSummary> getStandardVariableSummaries(final List<Integer> standardVariableIds) {
		...
		if (standardVariableIds != null && !standardVariableIds.isEmpty()) {
			final List<StandardVariableSummary> localVariables = this.getStandardVariableDao().getStarndardVariableSummaries(standardVariableIds);
	...
	public Map<String, List<StandardVariable>> getStandardVariablesInProjects(final List<String> headers, final String programUUID) {
		...
		for (final String name : headers) {
			final Set<Integer> varIds = (standardVariableIdsWithTypeInProjects.get(name.toUpperCase()) == null) ? null :
