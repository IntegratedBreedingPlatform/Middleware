...
/**
 * This POJO represents a row in reports about Transaction records.  Note that different reports require different
 * information and so some fields in this class may be null.  It is recommended to check if a field is available
 * first before trying to access it. The documentation for the methods generating the reports will provide
 * the list of information available from instances of this object returned by the methods.
 * 
