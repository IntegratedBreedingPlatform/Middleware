...
public class Location implements Serializable 
{
    ...
    public Location(Integer locid, UserDefinedField type, Integer nllp, String lname,
			String labbr, Integer snl3id, Integer snl2id, Integer snl1id,
			Country country, Integer lrplce)
	{
		super();
		this.locid = locid;
		this.type = type;
	...
	public String toString() {
		return "Location [locid=" + locid + ", nllp="
				+ nllp + ", lname=" + lname + ", labbr=" + labbr + ", snl3id="
				+ snl3id + ", snl2id=" + snl2id + ", snl1id=" + snl1id
				+ ", lrplce=" + lrplce + "]";
	}
