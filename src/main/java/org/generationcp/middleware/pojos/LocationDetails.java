 ...
 * 
 * select locid, lname as location_name, 
 * c.isofull as country_full_name,
 * labbr as location_abbreviation, 
 * ud.fname as location_type,
 * ud.fdesc as location_description
 * from location l
 * inner join cntry c on l.cntryid = c.cntryid
 * inner join udflds ud on ud.fldno = l.ltype
 * where locid = 1
 * 
...
/*    @OneToMany(mappedBy = "location")
    ...
    public LocationDetails(Integer locid,String location_name, String country_full_name, 
    		String location_abbreviation, String location_type, String  location_description) {
        super();
        this.locid = locid;
...
/*    public Set<Locdes> getDescriptions() {
    ...
    public static Comparator<LocationDetails> LocationNameComparator 
                          = new Comparator<LocationDetails>() {
        @Override
