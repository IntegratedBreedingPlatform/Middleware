...
public class ProjectRelationship implements Serializable {
	...
	public ProjectRelationship(Integer projectRelationshipId, DmsProject subjectProject, DmsProject objectProject, Integer typeId) {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + (this.projectRelationshipId == null ? 0 : this.projectRelationshipId.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (this.projectRelationshipId == null) {
			if (other.projectRelationshipId != null) {
				return false;
			}
		} else if (!this.projectRelationshipId.equals(other.projectRelationshipId)) {
			return false;
		}
		return true;
	}
	...
	public String toString() {
		...
		builder.append(this.projectRelationshipId);
		builder.append(", subjectProject=");
		builder.append(this.subjectProject);
		builder.append(", objectProject=");
		builder.append(this.objectProject);
