...
({
	@NamedQuery
	(
		name = "findAllGermplasm",
		query = "FROM Germplasm"
	),
	@NamedQuery
	(
		name = "countAllGermplasm",
		query = "SELECT COUNT(g) FROM Germplasm g"
	),
	//@NamedQuery
	//(
	...
	//	query = "SELECT COUNT(g) FROM Germplasm g WHERE g.method.mname = :name"
	//),
	@NamedQuery
	(
		name = "countGermplasmByMethodNameUsingEqual",
	...
	//	query = "SELECT COUNT(g) FROM Germplasm g WHERE g.method.mname like :name"
	//),
	@NamedQuery
	(
		name = "countGermplasmByMethodNameUsingLike",
	...
	//	query = "SELECT COUNT(g) FROM Germplasm g WHERE g.location.lname = :name"
	//),
	@NamedQuery
	(
		name = "countGermplasmByLocationNameUsingEqual",
	...
	//	query = "SELECT COUNT(g) FROM Germplasm g WHERE g.location.lname like :name"
	//),
	@NamedQuery
	(
		name = "countGermplasmByLocationNameUsingLike",
	...
	//	query = "SELECT g, n FROM Germplasm g left join g.names n WITH n.nstat = 1 WHERE g.gid = :gid"	
	//)
	//@NamedQuery
	//(
	//	name = "getGermplasmByGIDWithPrefAbbrev",
	//	query = "SELECT g, n, abbrev.nval FROM Germplasm g left join g.names n WITH n.nstat = 1 left join g.names abbrev WITH abbrev.nstat = 2 WHERE g.gid = :gid"
	//)
	//@NamedQuery
	//(
	//	name = "getProgenitorsByGIDWithPrefName",
	//	query = "SELECT g, n FROM Germplasm g LEFT JOIN g.names n WITH n.nstat = 1, Progenitor p " +
	//			"WHERE p.pid = g.gid AND p.progntrsPK.gid = :gid"	
	//)
	//@NamedQuery
	//(
	//	name = "countGermplasmDescendants",
	//	query = "SELECT count(distinct g) FROM Germplasm g LEFT JOIN g.progntr p WHERE g.gpid1=:gid or g.gpid2=:gid or p.pid=:gid"
	//),
	//@NamedQuery
	//(
	//	name = "getGermplasmManagementNeighbors",
	//	query = "SELECT g, n FROM Germplasm g left join g.names n WITH n.nstat = 1 WHERE g.mgid = :gid"	
	//),
	//@NamedQuery
	//(
	//	name = "getGermplasmGroupRelatives",
	//	query = "SELECT g, n FROM Germplasm g left join g.names n WITH n.nstat = 1, Germplasm g2 " +
	//			"WHERE g.gpid1 = g2.gpid1 AND g.gnpgs = -1 AND g.gid <> :gid AND g2.gid = :gid"	
	//)
	//@NamedQuery
	//(
	//	name = "getGermplasmDerivativeChildren",
	//	query = "SELECT g, n FROM Germplasm g left join g.names n WITH n.nstat = 1 WHERE g.gnpgs = -1 AND g.gpid2 = :gid"	
	//)
})
@NamedNativeQueries
({
	...
	@NamedNativeQuery
	(
		name = "findGermplasmByPrefName",
		query = "SELECT g.* FROM germplsm g LEFT JOIN names n ON g.gid = n.gid " +
				"AND n.nstat = 1 " +
				"WHERE n.nval = :name",
		resultClass = Germplasm.class
	),
...
//@XmlType(propOrder = {"gid", "gnpgs", "gpid1", "gpid2", "gdate", "methodMname", "locationLname"})
...
public class Germplasm implements Serializable 
{
    ...
    //public static final String GET_BY_GID_WITH_PREF_NAME = "getGermplasmByGIDWithPrefName";
    ...
    //public static final String GET_BY_GID_WITH_PREF_ABBREV = "getGermplasmByGIDWithPrefAbbrev";
    ...
    //public static final String COUNT_DESCENDANTS = "countGermplasmDescendants";
    ...
    //public static final String GET_PROGENITORS_BY_GID_WITH_PREF_NAME = "getProgenitorsByGIDWithPrefName";
    ...
    //public static final String GET_MANAGEMENT_NEIGHBORS = "getGermplasmManagementNeighbors";
    ...
    //public static final String GET_GROUP_RELATIVES = "getGermplasmGroupRelatives";
    ...
    //public static final String GET_DERIVATIVE_CHILDREN = "getGermplasmDerivativeChildren";
...
//    private Integer gchange;
    ...
    /**
    @OneToMany(mappedBy = "germplasm")
    private Set<Progenitor> progntr = new HashSet<Progenitor>();
    **/

    /**
     * This variable is populated only when the Germplasm POJO is retrieved by using GermplasmDataManager.getGermplasmWithPrefName()
     * and GermplasmDataManager.getGermplasmWithPrefAbbrev().  Otherwise it is null always.
     */
    @Transient
...
//    }
	...
	**/
	...
	public String getLocationLname()
	{
	...
	**/
	...
	/**
	public Set<Progenitor> getProgenitor()
	{
		return progntr;
	}

	public void setProgenitor(Set<Progenitor> progntr)
	{
		this.progntr = progntr;
	}
	**/
	...
	{
		return "Germplsm [gid=" + gid + ", gnpgs=" + gnpgs
				+ ", gpid1=" + gpid1 + ", gpid2=" + gpid2 + ", " 
				+ "lgid=" + lgid + ", gdate="
				+ gdate + ", grplce=" + grplce + ", mgid="
				+ mgid /*+ ", cid=" + cid + ", sid=" + sid + ", gchange="
				+ gchange */+ "]"; 
	}
