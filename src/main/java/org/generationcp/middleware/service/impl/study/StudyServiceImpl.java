	...
	public List<StudySummary> listAllStudies() throws MiddlewareQueryException {
        ...
        if (list != null && !list.isEmpty()) {
	        for (Object[] row : list){
	            ...
	            StudySummary studySummary = new StudySummary(id, name, title, objective, StudyType.getStudyTypeById(Integer.valueOf(studyTypeId)), startDate, endDate, programUUID);
