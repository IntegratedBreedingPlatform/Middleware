...
public class LocationDataResolver {
	...
	/**
	 * Resolves location related data at environment level. The required data will be set into the provided {@link AdvancingSource}
	 *
	 * @param source
	 * @param locationsByLocationId
	 */
	public void resolveEnvironmentLevelData(final AdvancingSource source, final Map<Integer, Location> locationsByLocationId) {
