    ...
    public static void getParentsDoubleRetroCrossNew(String[] mxp1, String[] mxp2) { 
        ...
        for (x = 1; x <= xp1.length(); x++) {
            if (xp1.substring(x - 1, x).equals(xp2.substring(x - 1, x))) {
                ...
                if (beforeStr.length() > 1 && NumberUtils.isNumber(beforeStr.substring(beforeStr.length() - 1, beforeStr.length())) && beforeStr.endsWith("*")) {
        ...
        // Fixing CleanBefore
        if (cleanBefore.length() > 1 && NumberUtils.isNumber(cleanBefore.substring(cleanBefore.length() - 1, cleanBefore.length())) 
        		&& (("/".equals(cleanBefore.substring(cleanBefore.length() - 2, cleanBefore.length() - 1))) 
    				|| ("*".equals(cleanBefore.substring(cleanBefore.length() - 1, cleanBefore.length()))))) {
