...
public class ResourceFinder {
	...
	/**
	 * This method is written by Martin Senger. This is taken from the org.generationcp.core.utils.Commons class from the PantheonConfig
	 * project.
	 * 
	 * Return the location of the specified resource by searching the current directory, user home directory, the current classpath and the
	 * system classpath.
	 * <p>
	 * 
	 * The code was inspired by Apache Commons class <tt>ConfigurationUtils</tt> (authors Herve Quiroz, Oliver Heger, and Emmanuel Bourg).
	 * <p>
	 * 
	 * @param name the name of the resource - usually a file name (absolute or relative)
	 * 
	 ...
	 */
	public URL locateFileWrapper(final String name) throws FileNotFoundException{
