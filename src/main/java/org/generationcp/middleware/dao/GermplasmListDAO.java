...
public class GermplasmListDAO extends GenericDAO<GermplasmList, Integer> {
    ...
    public List<GermplasmList> findByName(String name, int start,
	    int numOfRows, Operation operation) {
    ...
    @SuppressWarnings("unchecked")
    public List<GermplasmList> findByStatus(Integer status, int start,
	    int numOfRows) {
	Criteria criteria = getSession().createCriteria(GermplasmList.class);
