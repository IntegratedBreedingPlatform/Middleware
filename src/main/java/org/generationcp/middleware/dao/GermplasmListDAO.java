...
public class GermplasmListDAO extends GenericDAO<GermplasmList, Integer> {
	...
	private static final List<String> SNAPSHOT_LIST_TYPES = Arrays.asList(GermplasmListType.STUDY.name(), GermplasmListType.NURSERY.name(), GermplasmListType.TRIAL.name(),
