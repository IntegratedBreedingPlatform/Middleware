...
public class MappingPopValuesDAO extends GenericDAO<MappingPopValues, Integer>{
    ...
    public List<AllelicValueWithMarkerIdElement> getAllelicValuesByDatasetId(Integer datasetId, int start, int numOfRows) throws QueryException{
        ...
        try {
            ...
            throw new QueryException("Error with get allele values from mapping_pop_values by dataset id query: " + e.getMessage(), e);
        }
    ...
    public int countByDatasetId(Integer datasetId) throws QueryException{
        try {
            ...
            throw new QueryException("Error with count from mapping_pop_values by dataset id query: " + e.getMessage(), e);
        }        
    }
