...
public class GermplasmDAO extends GenericDAO<Germplasm, Integer> {
    public List<Germplasm> findAll(int start, int numOfRows)
	...
	try {
	    ...
	    throw new QueryException(
		    "Error with find all query for Germplasm: "
			    + ex.getMessage());
	}
    }

    public List<Germplasm> findByPrefName(String name, int start, int numOfRows)
	    throws QueryException {
	try {
	    Query query = getSession().getNamedQuery(
		    Germplasm.FIND_BY_PREF_NAME);
	    ...
	    throw new QueryException(
		    "Error with find by preferred name query for Germplasm: "
			    + ex.getMessage());
	}
    }
	...
	try {
	    Query query = getSession().createSQLQuery(
		    Germplasm.COUNT_BY_PREF_NAME);
	    query.setParameter("name", name);
	    BigInteger result = (BigInteger) query.uniqueResult();
	    return result;
	} catch (HibernateException ex) {
	    throw new QueryException(
		    "Error with count by preferred name for Germplasm: "
			    + ex.getMessage());
	}
    }

    @SuppressWarnings("unchecked")
    public List<Germplasm> findByName(String name, int start, int numOfRows,
	    Operation operation, Integer status, GermplasmNameType type) {
	StringBuilder queryString = new StringBuilder();
	queryString
		.append("SELECT {g.*} FROM germplsm g JOIN names n ON g.gid = n.gid WHERE ");
    ...
    public BigInteger countByName(String name, Operation operation,
	    Integer status, GermplasmNameType type) {
	StringBuilder queryString = new StringBuilder();
	queryString
		.append("SELECT COUNT(DISTINCT g.gid) FROM germplsm g JOIN names n ON g.gid = n.gid WHERE ");
    ...
    @SuppressWarnings("unchecked")
    public List<Germplasm> findByMethodNameUsingEqual(String name, int start,
	    int numOfRows) throws QueryException {
	try {
	    Query query = getSession().getNamedQuery(
		    Germplasm.FIND_BY_METHOD_NAME_USING_EQUAL);
	    query.setParameter("name", name);
	    query.setFirstResult(start);
	    query.setMaxResults(numOfRows);
	    ...
	    throw new QueryException(
		    "Error with find by method name query using equal for Germplasm: "
			    + ex.getMessage());
	}
    }
	...
	try {
	    Query query = getSession().getNamedQuery(
		    Germplasm.COUNT_BY_METHOD_NAME_USING_EQUAL);
	    query.setParameter("name", name);
	    Long result = (Long) query.uniqueResult();
	    return result;
	} catch (HibernateException ex) {
	    throw new QueryException(
		    "Error with count by method name using equal for Germplasm: "
			    + ex.getMessage());
	}
    }

    @SuppressWarnings("unchecked")
    public List<Germplasm> findByMethodNameUsingLike(String name, int start,
	    int numOfRows) throws QueryException {
	try {
	    Query query = getSession().getNamedQuery(
		    Germplasm.FIND_BY_METHOD_NAME_USING_LIKE);
	    query.setParameter("name", name);
	    query.setFirstResult(start);
	    query.setMaxResults(numOfRows);
	    ...
	    throw new QueryException(
		    "Error with find by method name using like query for Germplasm: "
			    + ex.getMessage());
	}
    }
	...
	try {
	    Query query = getSession().getNamedQuery(
		    Germplasm.COUNT_BY_METHOD_NAME_USING_LIKE);
	    query.setParameter("name", name);
	    Long result = (Long) query.uniqueResult();
	    return result;
	} catch (HibernateException ex) {
	    throw new QueryException(
		    "Error with count by method name using like for Germplasm: "
			    + ex.getMessage());
	}
    }

    @SuppressWarnings("unchecked")
    public List<Germplasm> findByLocationNameUsingEqual(String name, int start,
	    int numOfRows) throws QueryException {
	try {
	    Query query = getSession().getNamedQuery(
		    Germplasm.FIND_BY_LOCATION_NAME_USING_EQUAL);
	    query.setParameter("name", name);
	    query.setFirstResult(start);
	    query.setMaxResults(numOfRows);
	    ...
	    throw new QueryException(
		    "Error with find by location name query using equal for Germplasm: "
			    + ex.getMessage());
	}
    }

    public Long countByLocationNameUsingEqual(String name)
	    throws QueryException {
	try {
	    Query query = getSession().getNamedQuery(
		    Germplasm.COUNT_BY_LOCATION_NAME_USING_EQUAL);
	    query.setParameter("name", name);
	    Long result = (Long) query.uniqueResult();
	    return result;
	} catch (HibernateException ex) {
	    throw new QueryException(
		    "Error with count by location name using equal for Germplasm: "
			    + ex.getMessage());
	}
    }

    @SuppressWarnings("unchecked")
    public List<Germplasm> findByLocationNameUsingLike(String name, int start,
	    int numOfRows) throws QueryException {
	try {
	    Query query = getSession().getNamedQuery(
		    Germplasm.FIND_BY_LOCATION_NAME_USING_LIKE);
	    query.setParameter("name", name);
	    query.setFirstResult(start);
	    query.setMaxResults(numOfRows);
	    ...
	    throw new QueryException(
		    "Error with find by location name using like query for Germplasm: "
			    + ex.getMessage());
	}
    }
	...
	try {
	    Query query = getSession().getNamedQuery(
		    Germplasm.COUNT_BY_LOCATION_NAME_USING_LIKE);
	    query.setParameter("name", name);
	    Long result = (Long) query.uniqueResult();
	    return result;
	} catch (HibernateException ex) {
	    throw new QueryException(
		    "Error with count by location name using like for Germplasm: "
			    + ex.getMessage());
	}
    }
	...
	try {
	    SQLQuery query = getSession().createSQLQuery(
		    Germplasm.GET_BY_GID_WITH_PREF_NAME);
	    query.addEntity("g", Germplasm.class);
	    ...
	    throw new QueryException(
		    "Error with get by gid with pref name query for Germplasm: "
			    + ex.getMessage());
	}
    }
	...
	try {
	    SQLQuery query = getSession().createSQLQuery(
		    Germplasm.GET_BY_GID_WITH_PREF_ABBREV);
	    query.addEntity("g", Germplasm.class);
	    query.addEntity("n", Name.class);
	    ...
	    throw new QueryException(
		    "Error with get by gid with pref abbrev query for Germplasm: "
			    + ex.getMessage());
	}
    }
	...
	try {
	    ...
	    SQLQuery query = getSession().createSQLQuery(
		    Germplasm.GET_PROGENITORS_BY_GID_WITH_PREF_NAME);
	    query.addEntity("g", Germplasm.class);
	    query.addEntity("n", Name.class);
	    query.setParameter("gid", gid);
	    ...
	    throw new QueryException(
		    "Error with get progenitors by gid with pref name for Germplasm: "
			    + ex.getMessage());
	}
    }

    public List<Germplasm> getGermplasmDescendantByGID(Integer gid,
	    Integer start, Integer numOfRows) throws QueryException {
	try {
	    Query query = getSession()
		    .getNamedQuery(Germplasm.FIND_DESCENDANTS);
	    query.setParameter("gid", gid);
	    query.setFirstResult(start);
	    query.setMaxResults(numOfRows);
	    ...
	    throw new QueryException(
		    "Error with get Germplasm Descendant by Gid: "
			    + ex.getMessage());
	}
    }

    public Germplasm getProgenitorByGID(Integer gid, Integer pro_no)
	    throws QueryException {
	try {
	    ...
	    throw new QueryException(
		    "Error with get Germplasm Progenitor by Gid: "
			    + ex.getMessage());
	}
    }
	...
	try {
	    ...
	    SQLQuery query = getSession().createSQLQuery(
		    Germplasm.GET_MANAGEMENT_NEIGHBORS);
	    query.addEntity("g", Germplasm.class);
	    query.addEntity("n", Name.class);
	    query.setParameter("gid", gid);
	    ...
	    throw new QueryException(
		    "Error with get management neighbors query for Germplasm: "
			    + ex.getMessage());
	}
    }
	...
	try {
	    ...
	    throw new QueryException(
		    "Error with get group relatives query for Germplasm: "
			    + ex.getMessage());
	}
    }

    public List<Germplasm> getDerivativeChildren(Integer gid)
	    throws QueryException {
	try {
	    List<Germplasm> toreturn = new ArrayList<Germplasm>();
	    SQLQuery query = getSession().createSQLQuery(
		    Germplasm.GET_DERIVATIVE_CHILDREN);
	    query.addEntity("g", Germplasm.class);
	    query.addEntity("n", Name.class);
	    query.setParameter("gid", gid);
	    ...
	    throw new QueryException(
		    "Error with get derivative children query for Germplasm: "
			    + ex.getMessage());
	}
    }
