...
public class LotDAO extends GenericDAO<Lot, Integer> {
    ...
    @SuppressWarnings("unchecked")
    public List<Lot> findByEntityTypeAndEntityId(String type, Integer entityId,
    ...
    @SuppressWarnings("unchecked")
    public List<Lot> findByEntityTypeAndLocationId(String type,
    ...
    @SuppressWarnings("unchecked")
    public List<Lot> findByEntityTypeAndEntityIdAndLocationId(String type,
    ...
    public Long countByEntityTypeAndEntityIdAndLocationId(String type,
