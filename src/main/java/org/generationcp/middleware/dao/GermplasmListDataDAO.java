...
public class GermplasmListDataDAO extends
	GenericDAO<GermplasmListData, Integer> {
    @SuppressWarnings("unchecked")
    public List<GermplasmListData> getByListId(Integer id, int start,
	    int numOfRows) {
	Criteria criteria = getSession()
		.createCriteria(GermplasmListData.class);
    ...
    public GermplasmListData getByListIdAndEntryId(Integer listId,
	    Integer entryId) {
	Criteria criteria = getSession()
		.createCriteria(GermplasmListData.class);
	criteria.createAlias("list", "l");
    ...
    @SuppressWarnings("unchecked")
    public List<GermplasmListData> getByGID(Integer gid, int start,
	    int numOfRows) {
	Criteria criteria = getSession()
		.createCriteria(GermplasmListData.class);
	criteria.add(Restrictions.eq("gid", gid));
	...
	Query query = getSession().getNamedQuery(
		GermplasmListData.DELETE_BY_LIST_ID);
	query.setInteger("listId", listId);
	return query.executeUpdate();
    }

    public void validateId(GermplasmListData germplasmListData)
