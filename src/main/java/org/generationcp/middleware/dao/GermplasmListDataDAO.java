...
public class GermplasmListDataDAO extends GenericDAO<GermplasmListData, Integer>{
    ...
    public List<GermplasmListData> getByListId(Integer id, int start, int numOfRows) throws MiddlewareQueryException {
        try {
        	if (id != null){
	            ...
	            return getUpdatedGermplasmListData(criteria.list());
        	}
    ...
    private List<GermplasmListData> getUpdatedGermplasmListData(
			List<GermplasmListData> list) throws MiddlewareQueryException {
		...
		for (GermplasmListData germplasmListData : list) {
			GermplasmListData updatedGermplasmListData = 
					getUpdatedGermplasmListData(germplasmListData);
    ...
    private GermplasmListData getUpdatedGermplasmListData(
    		GermplasmListData germplasmListData) throws MiddlewareQueryException {
    	if(germplasmListData==null) {
    		return null;
    	}
    	Germplasm germplasm = getGermplasm(germplasmListData.getGid());
		if(germplasm == null) {
			return null;
    ...
    private Germplasm getGermplasm(Integer gid) throws MiddlewareQueryException {
		try {
            ...
            logAndThrowException("Error with getGermplasm(gid=" + gid + ") " + e.getMessage(), e);
        }
		return null;
	}
    ...
    public GermplasmListData getByListIdAndEntryId(Integer listId, Integer entryId) throws MiddlewareQueryException {
        try {
        	if (listId != null && entryId != null){
	            ...
	            criteria.add(Restrictions.ne("status", STATUS_DELETED));
	            criteria.addOrder(Order.asc("entryId"));
	            return getUpdatedGermplasmListData((GermplasmListData)criteria.uniqueResult());
        	}
        } catch (HibernateException e) {
