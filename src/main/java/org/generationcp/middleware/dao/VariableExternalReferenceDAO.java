...
public class VariableExternalReferenceDAO extends GenericDAO<ExperimentExternalReference, Integer> {

    private static final Logger LOG = LoggerFactory.getLogger(VariableExternalReferenceDAO.class);

    public List<ExternalReferenceDTO> getExternalReferences(final List<Integer> cvtermIds) {
