...
public class ProjectDAO extends GenericDAO<Project, Long> {
	...
	public Project getById(Long projectId) throws MiddlewareQueryException {
		try {
			...
			logAndThrowException("Error with getById(projectId=" + projectId
	...
	public Project getByName(String projectName)
		...
		try {
			...
			logAndThrowException("Error with getByName(projectName="
					+ projectName + ") query from Project: " + e.getMessage(),
					e);
		}
		return null;
	}
	...
	public Project getLastOpenedProject(Integer userId)
		...
		try {
			...
			logAndThrowException("Error with getLastOpenedProject(userId="
					+ userId + ") query from Project " + e.getMessage(), e);
		}
		return null;
	}
	...
	public Project getLastOpenedProjectAnyUser() throws MiddlewareQueryException {
		try {
			...
			logAndThrowException("Error with getLastOpenedProjectAnyUser("
					 + ") query from Project " + e.getMessage(), e);
		}
		return null;
	}
