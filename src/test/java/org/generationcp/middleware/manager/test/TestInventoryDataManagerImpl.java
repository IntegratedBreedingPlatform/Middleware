...
public class TestInventoryDataManagerImpl {
	...
	List<Lot> results = manager.findLotsByEntityTypeAndEntityId("GERMPLSM",
		new Integer(50533), 0, 5);
	Assert.assertTrue(results != null);
	Assert.assertTrue(!results.isEmpty());
	System.out.println("RESULTS:");
	for (Lot result : results)
	...
	System.out.println(manager.countLotsByEntityTypeAndEntityId("GERMPLSM",
		new Integer(50533)));
    }

    @Test
    public void testFindLotsByEntityTypeAndLocationId() throws Exception {
	List<Lot> results = manager.findLotsByEntityTypeAndLocationId(
		"GERMPLSM", new Integer(9000), 0, 5);
	Assert.assertTrue(results != null);
	Assert.assertTrue(!results.isEmpty());
	System.out.println("RESULTS:");
	for (Lot result : results)
	...
	System.out.println(manager.countLotsByEntityTypeAndLocationId(
		"GERMPLSM", new Integer(9000)));
    }

    @Test
    public void testFindLotsByEntityTypeAndEntityIdAndLocationId()
	    throws Exception {
	List<Lot> results = manager
		.findLotsByEntityTypeAndEntityIdAndLocationId("GERMPLSM",
			new Integer(50533), new Integer(9000), 0, 5);
	Assert.assertTrue(results != null);
	Assert.assertTrue(!results.isEmpty());
	System.out.println("RESULTS:");
	for (Lot result : results)
	...
	System.out.println(manager
		.countLotsByEntityTypeAndEntityIdAndLocationId("GERMPLSM",
			new Integer(50533), new Integer(9000)));
    }

    @Test
    public void testGetActualLotBalance() throws Exception {
	try {
	    System.out.println("getActualLotBalance(): "
		    + manager.getActualLotBalance(-1));
	} catch (Exception e) {
	    e.printStackTrace();
	}
    }
	...
	try {
	    System.out.println("getAvailableLotBalance(): "
		    + manager.getAvailableLotBalance(-1));
	} catch (Exception e) {
	    e.printStackTrace();
	}
    }
	...
	// this test assumes there are existing lot records with entity type =
	// GERMPLSM
	...
	Set<Transaction> transactions = manager
		.findTransactionsByLotId(new Integer(-1));
	...
	List<Transaction> transactions = manager
		.getAllReserveTransactionsByRequestor(new Integer(253), 0, 5);
	Assert.assertTrue(transactions != null);
	Assert.assertTrue(!transactions.isEmpty());
	for (Transaction t : transactions)
	    System.out.println(t);
	...
	System.out.println(manager
		.countAllReserveTransactionsByRequestor(new Integer(253)));
    }

    @Test
    public void testGetAllDepositTransactionsByDonor() throws Exception {
	List<Transaction> transactions = manager
		.getAllDepositTransactionsByDonor(new Integer(253), 0, 5);
	Assert.assertTrue(transactions != null);
	Assert.assertTrue(!transactions.isEmpty());
	for (Transaction t : transactions)
	    System.out.println(t);
	...
	System.out.println(manager
		.countAllDepositTransactionsByDonor(new Integer(253)));
    }

    @Test
    public void testGenerateReportOnAllUncommittedTransactions()
	    throws Exception {
	System.out.println("Number of uncommitted transactions: "
		+ manager.countAllUncommittedTransactions());
	List<TransactionReportRow> report = manager
		.generateReportOnAllUncommittedTransactions(0, 5);
	...
	System.out.println("Number of reserve transactions: "
		+ manager.countAllReserveTransactions());
	List<TransactionReportRow> report = manager
		.generateReportOnAllReserveTransactions(0, 5);
	Assert.assertTrue(report != null);
	Assert.assertTrue(!report.isEmpty());
	System.out.println("REPORT:");
	for (TransactionReportRow row : report)
	...
	List<TransactionReportRow> report = manager
		.generateReportOnAllWithdrawalTransactions(0, 5);
	Assert.assertTrue(report != null);
	Assert.assertTrue(!report.isEmpty());
	System.out.println("REPORT:");
	for (TransactionReportRow row : report)
	...
	List<LotReportRow> report = manager.generateReportOnDormantLots(2012,
		0, 10);
	Assert.assertTrue(report != null);
	Assert.assertTrue(!report.isEmpty());
	System.out.println("REPORT:");
	...
	List<LotReportRow> report = manager.generateReportOnLotsByEntityType(
		"GERMPLSM", 0, 10);
	Assert.assertTrue(report != null);
	Assert.assertTrue(!report.isEmpty());
	System.out.println("REPORT:");
    ...
    public void testGenerateReportOnLotsByEntityTypeAndEntityId()
	    throws Exception {
	System.out
		.println("Balance Report on Lots by Entity Type and Entity ID:");
	List<Integer> entityIdList = new ArrayList<Integer>();
	entityIdList.add(50533);
	entityIdList.add(3);
	List<LotReportRow> report = manager
		.generateReportOnLotsByEntityTypeAndEntityId("GERMPLSM",
			entityIdList, 0, 10);
	Assert.assertTrue(report != null);
	Assert.assertTrue(!report.isEmpty());
	System.out.println("REPORT:");
	...
	List<LotReportRow> report = manager
		.generateReportOnLotsWithMinimumAmount(700, 0, 5);
	Assert.assertTrue(report != null);
	System.out.println("REPORT:");
	for (LotReportRow row : report)
	    System.out.println(row);
