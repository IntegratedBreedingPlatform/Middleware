...
public class GermplasmAddUpdateFunctionsTest extends DataManagerIntegrationTest {
    ...
    public void testAddAndUpdateGermplasm() throws Exception {
        ...
        Integer addedGid = manager.addGermplasm(g,n);
        
        Debug.println(0, "Germplasm added: " + addedGid); 
        
        Germplasm oldG = manager.getGermplasmByGID(addedGid);
        Name name = manager.getNameByGIDAndNval(addedGid, n.getNval(), GetGermplasmByNameModes.NORMAL);
        ...
        Germplasm newG = manager.getGermplasmByGID(addedGid);
        ...
        gList.add(newG);
        manager.updateGermplasm(gList);
        Germplasm newerG = manager.getGermplasmByGID(newG.getGid());
        assertNull(newerG);
        Debug.println(INDENT, "testUpdateGermplasm(" + addedGid + ")");
