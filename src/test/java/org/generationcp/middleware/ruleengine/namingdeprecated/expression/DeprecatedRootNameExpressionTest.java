...
public class DeprecatedRootNameExpressionTest extends DeprecatedTestExpression {

	private DeprecatedRootNameExpression rootNameExpression;

	@Before
	public void init() {

		this.rootNameExpression = new DeprecatedRootNameExpression();
