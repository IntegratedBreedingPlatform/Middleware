...
public class DeprecatedNumberExpressionTest extends DeprecatedTestExpression {
	...
	private DeprecatedNumberExpression expression;

	@Before
	public void setup() {
		this.expression = new DeprecatedNumberExpression();
