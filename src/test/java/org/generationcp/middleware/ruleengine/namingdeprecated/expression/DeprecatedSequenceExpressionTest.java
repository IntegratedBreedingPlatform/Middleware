...
public class DeprecatedSequenceExpressionTest extends DeprecatedTestExpression {
	...
	private DeprecatedSequenceExpression expression;
	...
	public void setup() {
		...
		this.expression = new DeprecatedSequenceExpression();
