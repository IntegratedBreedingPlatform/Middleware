...
public class DeprecatedAttributeFemaleParentExpressionTest extends DeprecatedTestExpression {

	@Mock
	private GermplasmDataManager germplasmDataManager;

	@InjectMocks
	DeprecatedAttributeFemaleParentExpression expression = new DeprecatedAttributeFemaleParentExpression();
