...
public class DeprecatedAttributeSourceExpressionTest extends DeprecatedTestExpression {

	@Mock
	private GermplasmDataManager germplasmDataManager;

	@InjectMocks
	DeprecatedAttributeSourceExpression expression = new DeprecatedAttributeSourceExpression();
