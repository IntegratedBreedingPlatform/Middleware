...
public class DeprecatedAttributeMaleParentExpressionTest extends DeprecatedTestExpression {

	@Mock
	private GermplasmDataManager germplasmDataManager;

	@InjectMocks
	DeprecatedAttributeMaleParentExpression expression = new DeprecatedAttributeMaleParentExpression();
