...
public class DeprecatedGermplasmNamingServiceImplTest {
	...
	@InjectMocks
	private DeprecatedGermplasmNamingServiceImpl germplasmNamingService;
	...
	public void testBuildDesignationNameInSequenceDefaultSetting() {
		...
		defaultSetting.setPrefix(DeprecatedGermplasmNamingServiceImplTest.PREFIX);
		defaultSetting.setSuffix(DeprecatedGermplasmNamingServiceImplTest.SUFFIX);
	...
	public void testGetNextSequence() {
		...
		Assert.assertEquals(DeprecatedGermplasmNamingServiceImplTest.NEXT_NUMBER.intValue(), nextNumber);
	...
	private String buildExpectedNextName() {
		return DeprecatedGermplasmNamingServiceImplTest.PREFIX + " 00000" + NEXT_NUMBER + " "
			+ DeprecatedGermplasmNamingServiceImplTest.SUFFIX;
	}
	...
	public void testGetNextNameInSequenceWhenSpecifiedSequenceStartingNumberIsGreater() {
		...
		Assert.assertEquals("The specified starting sequence number will be used since it's larger.",
			DeprecatedGermplasmNamingServiceImplTest.PREFIX + " 000" + startNumber + " " + DeprecatedGermplasmNamingServiceImplTest.SUFFIX,
			nextNameInSequence);
	}
	...
	public void testGetNextNameInSequenceWhenSpecifiedSequenceStartingNumberIsLower() {
		final GermplasmNameSetting setting = this.createGermplasmNameSetting();
		final int startNumber = DeprecatedGermplasmNamingServiceImplTest.NEXT_NUMBER - 1;
		setting.setStartNumber(startNumber);
		try {
	...
	private GermplasmNameSetting createGermplasmNameSetting() {
		...
		setting.setPrefix(DeprecatedGermplasmNamingServiceImplTest.PREFIX);
		setting.setSuffix(DeprecatedGermplasmNamingServiceImplTest.SUFFIX);
		setting.setAddSpaceBetweenPrefixAndCode(true);
		setting.setAddSpaceBetweenSuffixAndCode(true);
