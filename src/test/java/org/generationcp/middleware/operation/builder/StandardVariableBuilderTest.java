...
public class StandardVariableBuilderTest extends DataManagerIntegrationTest {
	...
	public void testCreate() throws MiddlewareException {
		StandardVariable standardVariable = standardVariableBuilder.create(
				TermId.TRIAL_INSTANCE_FACTOR.getId(), null);
	...
	public void testCreate_List() throws MiddlewareException {
		...
		List<StandardVariable> standardVariables = standardVariableBuilder.create(
				standardVariableIds, null);
		...
		for (StandardVariable standardVariable : standardVariables) {
			assertTrue(standardVariable.getId() == TermId.ENTRY_NO.getId() || 
					standardVariable.getId() == TermId.GID.getId());
	...
	public void testFindOrSave_Find() throws MiddlewareException {
		...
		StandardVariable standardVariable = standardVariableBuilder.findOrSave(name, 
				description, property, scale, method, role, datatype, null);
		assertNotNull(standardVariable);
		assertEquals(TermId.TRIAL_INSTANCE_FACTOR.getId(),standardVariable.getId());
		assertEquals(TRIAL_INSTANCE_PROPERTY_ID,standardVariable.getProperty().getId());
		assertEquals(TRIAL_INSTANCE_SCALE_ID,standardVariable.getScale().getId());
	...
	public void testGetByName() throws MiddlewareException {
		String name = "TRIAL_INSTANCE";
		StandardVariable standardVariable = standardVariableBuilder.getByName(
				name, null);
		assertNotNull(standardVariable);
		assertEquals(TermId.TRIAL_INSTANCE_FACTOR.getId(),standardVariable.getId());
		assertEquals(name,standardVariable.getName());
	...
	public void testGetByPropertyScaleMethod() throws MiddlewareException {
		...
		StandardVariable standardVariable = standardVariableBuilder.
				getByPropertyScaleMethod(propertyId, scaleId, methodId, null);
		assertNotNull(standardVariable);
		assertEquals(TRIAL_INSTANCE_PROPERTY_ID,standardVariable.getProperty().getId());
		assertEquals(TRIAL_INSTANCE_SCALE_ID,standardVariable.getScale().getId());
		assertEquals(TRIAL_INSTANCE_METHOD_ID,standardVariable.getMethod().getId());
	...
	public void testGetByPropertyScaleMethodRole() throws MiddlewareException {
		...
		PhenotypicType role = PhenotypicType.TRIAL_ENVIRONMENT;
		StandardVariable standardVariable = standardVariableBuilder.
				getByPropertyScaleMethodRole(propertyId, scaleId, methodId, role, null);
		assertNotNull(standardVariable);
		assertEquals(TRIAL_INSTANCE_PROPERTY_ID,standardVariable.getProperty().getId());
		assertEquals(TRIAL_INSTANCE_SCALE_ID,standardVariable.getScale().getId());
		assertEquals(TRIAL_INSTANCE_METHOD_ID,standardVariable.getMethod().getId());
	...
	public void testGetStandardVariablesInProjects() throws MiddlewareException {
		List<String> headers = createLocalVariableNamesOfProjectTestData();
		Map<String, List<StandardVariable>> stdVars = standardVariableBuilder.
				getStandardVariablesInProjects(headers, null);
