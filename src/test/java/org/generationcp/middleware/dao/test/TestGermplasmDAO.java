...
public class TestGermplasmDAO 
{
	...
	@Test
	public void testFindByPrefName() throws Exception
	{
		List<Germplasm> germplsmList = dao.findByPrefName("IR 64", 0, 5);
		Assert.assertTrue(germplsmList != null);
		Assert.assertTrue(germplsmList.size() >= 5);
	...
	@Test
	public void testCountByPrefName() throws Exception
	{
		BigInteger count = dao.countByPrefName("IR 64");
		Assert.assertTrue(count != null);
		System.out.println("COUNT = " + count);
	}
	
	@Test
	public void testGetProgenitorsByGIDWithPrefName() throws Exception
	{
		List<Germplasm> results = dao.getProgenitorsByGIDWithPrefName(new Integer(306436));
		Assert.assertTrue(results.size() > 0);
		System.out.println("RESULTS:");
		for(Germplasm g : results)
		{
			System.out.println(g);
			System.out.println(g.getPreferredName());
		}
	}
	**/
