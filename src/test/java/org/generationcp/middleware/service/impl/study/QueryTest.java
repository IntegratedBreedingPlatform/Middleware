...
public class QueryTest {
	...
	public void testMeasurementQueryGeneration() throws Exception {
		...
		System.out.println(this.formatString(result));
		Assert.assertEquals("The expected query must match our expected queyr",
				this.formatString(this.expectedQueryForTheQueryGenerationTest()), this.formatString(result));
	}
