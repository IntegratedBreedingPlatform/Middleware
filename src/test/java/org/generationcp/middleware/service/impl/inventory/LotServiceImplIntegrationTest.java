...
public class LotServiceImplIntegrationTest extends IntegrationTestBase {
	...
	public void testCaseSensitivyOfStockId() {
		...
		final Lot lot1 = new Lot(null, this.userId, EntityType.GERMPLSM.name(), germplasm1.getGid(), this.storageLocationId, UNIT_ID, LotStatus.ACTIVE.getIntValue(), 0, "Lot", "AAA");
		...
		final Lot lot2 = new Lot(null, this.userId, EntityType.GERMPLSM.name(), germplasm2.getGid(), this.storageLocationId, UNIT_ID, LotStatus.ACTIVE.getIntValue(), 0, "Lot", "aaa");
		try {
