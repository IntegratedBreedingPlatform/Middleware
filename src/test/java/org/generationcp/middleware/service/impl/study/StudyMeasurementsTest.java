...
public class StudyMeasurementsTest {
	...
	public void allPlotsMeasurementQueryRetrievesDataCorrectly() throws Exception {
		...
		this.verifyObservationValues(measurement1, StudyMeasurementsTest.OBS_UNIT_IDENTIFIER1, StudyMeasurementsTest.GID1,
			...
			Arrays.asList(
				new ImmutablePair<>(StudyMeasurementsTest.ROW1_TRAIT1_PHENOTYPE_ID,
					StudyMeasurementsTest.ROW1_TRAIT1_VALUE),
				new ImmutablePair<>(StudyMeasurementsTest.ROW1_TRAIT2_PHENOTYPE_ID,
					StudyMeasurementsTest.ROW1_TRAIT2_VALUE)),
			Arrays.asList(new ImmutablePair<>(StudyMeasurementsTest.STOCK_ID,
				StudyMeasurementsTest.STOCKID1)),
			Arrays.asList(
				new ImmutablePair<>(StudyMeasurementsTest.FACT1,
					StudyMeasurementsTest.FACT1_VALUE1),
				new ImmutablePair<>(StudyMeasurementsTest.FACT2,
					StudyMeasurementsTest.FACT2_VALUE1)));
		...
		this.verifyObservationValues(measurement2, StudyMeasurementsTest.OBS_UNIT_IDENTIFIER2, StudyMeasurementsTest.GID2,
			...
			Arrays.asList(
				new ImmutablePair<>(StudyMeasurementsTest.ROW2_TRAIT1_PHENOTYPE_ID,
					StudyMeasurementsTest.ROW2_TRAIT1_VALUE),
				new ImmutablePair<>(StudyMeasurementsTest.ROW2_TRAIT2_PHENOTYPE_ID,
					StudyMeasurementsTest.ROW2_TRAIT2_VALUE)),
			Arrays.asList(new ImmutablePair<>(StudyMeasurementsTest.STOCK_ID,
	...
	public void testGetAllStudyDetailsAsTable() {
		...
		final Object[] result = {
			1, 1, "Test", 1, "desig", 1, "entry code", "1", "PLOT_NO", "1", 1, 1, "OBS_UNIT_ID",
