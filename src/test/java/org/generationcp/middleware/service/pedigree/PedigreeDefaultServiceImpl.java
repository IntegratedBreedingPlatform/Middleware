...
public class PedigreeDefaultServiceImpl implements PedigreeService {
	...
	public PedigreeDefaultServiceImpl(final HibernateSessionProvider sessionProvider, final String cropName) {
	...
	public String getCrossExpansion(final Integer gid, final Integer level, final CrossExpansionProperties crossExpansionProperties) {
		...
		try {
			final Germplasm germplasm = this.pedigreeDataManagerFactory.getGermplasmDataManager().getGermplasmWithPrefName(gid);
			if (germplasm != null) {
				final SingleGermplasmCrossElement startElement = new SingleGermplasmCrossElement();
				startElement.setGermplasm(germplasm);
				final GermplasmCrossElement cross =
	...
	private GermplasmCrossElement expandGermplasmCross(final GermplasmCrossElement element, final int level, final boolean forComplexCross) {
		if (level == 0) {
			...
			if (element instanceof SingleGermplasmCrossElement) {
				final SingleGermplasmCrossElement singleGermplasm = (SingleGermplasmCrossElement) element;
				final Germplasm germplasmToExpand = singleGermplasm.getGermplasm();
				...
				if (germplasmToExpand.getGnpgs() < 0) {
					...
					if (germplasmToExpand.getGpid1() != null && germplasmToExpand.getGpid1() != 0 && !forComplexCross) {
						final SingleGermplasmCrossElement nextElement = new SingleGermplasmCrossElement();
						final Germplasm gpid1Germplasm =
					...
					final Method method = germplasmToExpand.getMethod();
					if (method != null) {
						...
						if (methodName.contains("single cross")) {
							...
							final Germplasm firstParent =
									this.pedigreeDataManagerFactory.getGermplasmDataManager().getGermplasmWithPrefName(
											germplasmToExpand.getGpid1());
							final SingleGermplasmCrossElement firstParentElem = new SingleGermplasmCrossElement();
							firstParentElem.setGermplasm(firstParent);

							final Germplasm secondParent =
									this.pedigreeDataManagerFactory.getGermplasmDataManager().getGermplasmWithPrefName(
											germplasmToExpand.getGpid2());
							final SingleGermplasmCrossElement secondParentElem = new SingleGermplasmCrossElement();
							secondParentElem.setGermplasm(secondParent);

							// expand the parents as needed, depends on the
							// level
							final GermplasmCrossElement expandedFirstParent =
									this.expandGermplasmCross(firstParentElem, level - 1, forComplexCross);
							final GermplasmCrossElement expandedSecondParent =
							...
							final SingleGermplasmCrossElement firstGrandParentElem = new SingleGermplasmCrossElement();
							Germplasm secondGrandParent = null;
							final SingleGermplasmCrossElement secondGrandParentElem = new SingleGermplasmCrossElement();
							if (firstParent != null) {
								firstGrandParent =
										this.pedigreeDataManagerFactory.getGermplasmDataManager().getGermplasmWithPrefName(
							...
							final SingleGermplasmCrossElement thirdGrandParentElem = new SingleGermplasmCrossElement();
							Germplasm fourthGrandParent = null;
							final SingleGermplasmCrossElement fourthGrandParentElem = new SingleGermplasmCrossElement();
							...
							// grand parents
							final GermplasmCross firstCross = new GermplasmCross();
							...
							// grand parents
							final GermplasmCross secondCross = new GermplasmCross();
							if (secondParent != null) {
							...
							if (firstParent != null && firstParent.getGnpgs() > 0) {
								...
								// cross
								final Germplasm firstGrandParent =
										this.pedigreeDataManagerFactory.getGermplasmDataManager().getGermplasmWithPrefName(
												firstParent.getGpid1());
								final SingleGermplasmCrossElement firstGrandParentElem = new SingleGermplasmCrossElement();
								firstGrandParentElem.setGermplasm(firstGrandParent);

								final Germplasm secondGrandParent =
										this.pedigreeDataManagerFactory.getGermplasmDataManager().getGermplasmWithPrefName(
												firstParent.getGpid2());
								final SingleGermplasmCrossElement secondGrandParentElem = new SingleGermplasmCrossElement();
								secondGrandParentElem.setGermplasm(secondGrandParent);
							...
							final BackcrossElement backcross = new BackcrossElement();
							...
							if (firstParent != null && secondParent != null) {
								final SingleGermplasmCrossElement recurringParentElem = new SingleGermplasmCrossElement();
								final SingleGermplasmCrossElement parentElem = new SingleGermplasmCrossElement();
								if (secondParent.getGnpgs() >= 2) {
									if (firstParent.getGid().equals(secondParent.getGpid1())
										...
										final Object[] numOfDosesAndOtherParent =
								...
								if (itsABackCross) {
									final GermplasmCrossElement expandedRecurringParent =
									...
									final GermplasmCrossElement expandedParent =
							...
							// expand the parents as needed, depends on the
							// level
							final GermplasmCrossElement expandedFirstParent = this.expandGermplasmCross(firstParentElem, level, true);
							final GermplasmCrossElement expandedSecondParent = this.expandGermplasmCross(secondParentElem, level, true);
							...
							final SingleGermplasmCrossElement crossElement = new SingleGermplasmCrossElement();
	 ...
	 */
	private Object[] determineNumberOfRecurringParent(final Integer recurringParentGid, final Germplasm toCheck) {
		final Object[] toreturn = new Object[2];
		if (toCheck == null) {
			...
			final Object[] returned = this.determineNumberOfRecurringParent(recurringParentGid, nextToCheck);
	...
	@Override
	public Map<Integer, String> getCrossExpansions(final Set<Integer> gids, final Integer level, final CrossExpansionProperties crossExpansionProperties) {
